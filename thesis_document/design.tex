...
The proposed algorithm inserts additional instructions into the functions of a program through manipulation of the function's control flow graph. 
...
If a program has multiple functions then each function is represented by its own CFG. 
