...
Recently Busi et. al \cite{busi} proposed a design for  interruptible enclaves that is able to close timing-leaks. They define a security criterion and prove that 
their design satisfies it. 
